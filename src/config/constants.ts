...
// This fork's repo, used by the in-app update checker to find new releases.
const GITHUB_REPO = 'filipmares/browserosaurus'

export { B_URL, CARROT_URL, GITHUB_REPO, ISSUES_URL, UPSTREAM_URL }
